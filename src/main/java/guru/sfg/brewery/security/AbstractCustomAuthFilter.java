...
public abstract class AbstractCustomAuthFilter extends AbstractAuthenticationProcessingFilter {
    ...
    @Override
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse responmse) throws AuthenticationException, IOException, ServletException {
